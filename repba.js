...
const MAXVIRTUALWIDTH = SAFARI?5760:3840; 
const DRAWCOUNT = 16;
const SWIPETIME = 60;
...
globalobj.slidereduce = globalobj.slidecount/30;
...
var contextobj = new makeoption("CONTEXT", contextlst);

var canvaslst = [];
var canvasobj = new makeoption("CANVAS", canvaslst);
